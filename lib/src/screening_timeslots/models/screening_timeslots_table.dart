...
class ScreeningTimeslotsTable extends Table {
  ...
  TextColumn get specimenCollectionTime =>
      text().nullable().withLength(max: 255)();
  TextColumn get specimenCollectionVenue =>
  ...
  IntColumn get venueId => integer()
      .references(ScreeningVenuesTable, #id, onDelete: KeyAction.cascade)();
}
