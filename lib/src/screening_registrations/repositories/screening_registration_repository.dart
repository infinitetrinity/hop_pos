...
class ScreeningRegistrationRepository {
  ...
  Future<int> getScreeningRegistrationsCount(Screening screening) async {
    return await screeningRegistrationDao.getScreeningRegistrationsCount(screening);
  }

  Future<List<CustomerWithRegistration>> searchScreeningCustomers(Screening screening, String search) async {
    return await screeningRegistrationDao.searchScreeningCustomers(screening, search);
  }
}
