...
@TableIndex(name: 'receipt_settings_id', columns: {#id}, unique: true)
...
class ReceiptSettingsTable extends Table {
  ...
  TextColumn get outstandingSpecimenTitle => text().nullable().withLength(max: 999)();
  TextColumn get outstandingSpecimenNoticeTitle => text().nullable().withLength(max: 999)();
  TextColumn get outstandingSpecimenNotice => text().nullable().withLength(max: 999)();
