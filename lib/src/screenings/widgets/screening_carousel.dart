...
class ScreeningCarousel extends StatefulHookWidget {
  const ScreeningCarousel({super.key, required this.screenings});
  final List<List<Screening>> screenings;

  @override
  State<ScreeningCarousel> createState() => _ScreeningCarouselState();
}

class _ScreeningCarouselState extends State<ScreeningCarousel> {
