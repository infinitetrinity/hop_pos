...
OutputDir=C:\ITC\HopPos\hop_pos\installers
OutputBaseFilename=hop_pos
SetupIconFile=C:\ITC\HopPos\hop_pos\windows\runner\resources\app_icon.ico
Compression=lzma
...
[Files]
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\screen_retriever_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\sqlite3.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\sqlite3_flutter_libs_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\url_launcher_windows_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\window_manager_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\ITC\HopPos\hop_pos\build\windows\x64\runner\Release\data\*"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
